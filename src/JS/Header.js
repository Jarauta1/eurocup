       ...
       /*  localStorage.setItem("retorno", "/") */
        return(<>
            ...
            <section class="top-nav">
                ...
                <ul class="menu-header"> 
                    <li><Link to="/grupos"><a>FASE GRUPOS</a></Link></li>
                    <li><Link to="/eliminatorias"><a>ELIMINATORIAS</a></Link></li>
                    <li><Link to="/clasificacion"><a>CLASIFICACIÓN</a></Link></li>
                    <li><Link to="/apuesta"><a>APUESTA</a></Link></li>
